    ...
    <div className="meditation-page">
      ...
      <div className="text-and-meditations">
        <div className="left-block">
          ...
          <p>
            Breathing calms your nerves because slow, deep breaths lower stress,
            slow your heartbeat, and help you focus on your body instead of
            anxious thoughts. This page has simple breathing techniques to help
            you relax and feel calm.
          </p>
        </div>
