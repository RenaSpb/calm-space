...
export default function TopBar({ setActivePage, activePage, bgPlaying, toggleBgMusic }) {
  return (
    <header className="topbar">
      <button
        className={`topbar-button ${
          activePage === "mood-tracker" ? "active" : ""
        }`}
